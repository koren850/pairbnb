		...
		<div>
			<div className="stay-preview">
				...
				<div className="stay-preview-details">
					...
					<div className="stay-type-country">{stay.type} • {stay.loc.address}</div>
					<div className="stay-name">{stay.name}</div>
					<div className="stay-price-night"><div className="stay-price">${stay.price} / </div><div className="stay-night"> night</div></div>
