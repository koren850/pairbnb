                ...
                >
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                        ...
                        <GoogleLogin
                            ...
                            render={renderProps => (
                                <GoogleLoginButton style={{ display: 'flex', justifyContent: 'center', height: '35px', margin: '10px 0', width: '396px' }} onClick={renderProps.onClick} disabled={renderProps.disabled}>Sign in with Google</GoogleLoginButton>
                            )}
